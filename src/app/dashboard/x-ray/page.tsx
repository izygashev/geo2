      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F5F5F4]">
            <Terminal className="h-4 w-4 text-[#787774]" />
          </div>
          <div>
            <h1 className="text-lg font-bold tracking-tighter text-[#1a1a1a]">
              AI-Рентген
            </h1>
            <p className="text-xs text-[#787774]">Deep AI Perception Scan</p>
          </div>
        </div>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[#787774]">
          Глубокий анализ того, как разные AI-модели воспринимают и описывают ваш бренд.
          Выявляйте искажения, галлюцинации и несоответствия.
        </p>
      </div>
