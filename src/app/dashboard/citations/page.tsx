      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-[#787774]">AI Source Tracking</p>
          </div>
        </div>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[#787774]">
          Отслеживайте, где и как AI-системы цитируют ваш сайт.
          Находите новые источники цитирования и увеличивайте авторитет бренда.
        </p>
      </div>
